...
\\
In den 70er-Jahren kam schliesslich das Internet und mit dem Internet das grosse Zeitalter der E-Mail. Die E-Mail war zu Beginn die meistgenutzte und wichtigste Anwendung des Internets und schon 1971 brauchte der E-Mail-Verkehr mehr Datenvolumen als alle anderen Dienste zusammen\footnote{\hyperlink{link11}{Wikipedia: Internet, Linkverzeichnis, Link 11}}
...
Ein weiterer Meilenstein in der Geschichte des Internets ist der Webbrowser. Mit der Einführung des ersten grafikfähigen Webbrowsers Mosaic im Jahre 1993 erhielt das Internet einen weiteren Aufwärtsschub\footnote{\hyperlink{link12}{Wikipedia: NCSA Mosaic, Linkverzeichnis, Link 12}}.
...
\footnote{\hyperlink{link13}{Wikipedia: Blackbox, Linkverzeichnis, Link 13}}.
\end{quote}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{images/BlackBox}
\caption{Black Box}
\end{figure}
