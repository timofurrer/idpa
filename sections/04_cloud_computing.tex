...
\begin{itemize}
\item kostenlos
\item kostenloser Support durch Community
\item open source
\item Anwender ist Souverän
\item Einsatz von Verschlüsselung bei Speicher und Übertragung
\item Da man die Clound auf einem eigenen Rechner hat und der eine eigene Adresse besitzt, müsste ein Angreifer diese erst ausfindig machen -> Wenn man nicht weiss ob es existiert, kann man es auch nicht knacken.
\end{itemize}
...
\item Von Zuhause aus eher langsame Verbindung
\end{itemize}
